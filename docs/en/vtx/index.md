...
Configure these via the command line interface.
...
- `aux_channel`: AUX channel number (4-19, where AUX1=4)
...
:::info
AUX channel numbering starts from 4 (AUX1=channel 4) to account for the first four RC channels used for flight control.
:::
